...
public class User
{
    ...
    public virtual ICollection<DocumentShare> SharedByUserDocumentShares { get; set; } = new List<DocumentShare>();
    public virtual ICollection<DocumentShare> SharedWithUserDocumentShares { get; set; } = new List<DocumentShare>();
}
